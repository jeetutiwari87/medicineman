    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 hidden-sm hidden-xs text-left padding_10 contact_v5">
                    <p><a href="callto:<?php echo esc_url($foodfarm_settings['header-contact-phonenumber']) ?>"><i class="fa fa-phone"></i><span><?php echo $foodfarm_settings['header-contact-phonenumber'] ?></span></a></p>
            </div>
            <?php endif; ?>
