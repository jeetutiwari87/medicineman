...
class AlkaFacebook{
     ...
     * @var string
     */
    private $app_id = '1910740069180340';
     ...
     * @var string
     */
    private $app_secret = '5c0cdb09fc52f25f0bda87bd8b45c92d';
     ...
     * @var string
     */
    private $callback_url = 'http://medicinemanshop.ca/wp-admin/admin-ajax.php?action=alka_facebook';
    ...
    public function renderShortcode() {
        ...
        // Button
        $html .= '<a href="'.$this->getLoginUrl().'" class="btn" id="alka-facebook-button">
				<img src="'.get_template_directory_uri('template_url').'/images/facebook-login.png"  style="width: 50%;"/>
		</a>';
