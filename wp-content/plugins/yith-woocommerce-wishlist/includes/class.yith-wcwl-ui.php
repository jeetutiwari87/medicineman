...
if( ! class_exists( 'YITH_WCWL_UI' ) ) {
    ...
    class YITH_WCWL_UI {
        ...
        public static function add_to_wishlist_button( $url, $product_type, $exists ) {
            ...
            $html .= '<div class="yith-wcwl-wishlistexistsbrowse fdgdfgdfg ' . ( $exists ? 'show' : 'hide' ) . '" style="display:' . ( $exists ? 'block' : 'none' ) . '"> <a href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yith-woocommerce-wishlist' ) ) . '</a></div>';
