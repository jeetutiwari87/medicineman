	    ...
	    public function init_form_fields() {
	    	...
	    	$this->form_fields = array(
				...
				'instructions' => array(
					...
					'default'     => __( 'After placing your order, please send an Email money transfer to the following:<br /><br />Email: mminvoices1001@gmail.com<br />Secret Question: Your Order Number - {1}<br /><br />Secret Answer: peaceandlove (MAKE SURE YOU DO NOT REMOVE THESE TWO PARAMETERS)<br /><br />Thanks for choosing us! We appreciate your business.', 'emt_gateway' ),
					'desc_tip'    => true,
				),
