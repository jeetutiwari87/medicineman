    ...
    if (get_option('rs_color_scheme') == '1') {
        ?><style>
            ...
            .rs_membership_compatible_wrapper h2{
                background:#777 url(<?php echo REWARDSYSTEM_PLUGIN_DIR_URL . "admin/images/arrow-216-12.png" ?>) right 15px center no-repeat !important;
                border:0px !important;
                font-size:16px !important;
                color:#000 !important;
                font-family: 'Roboto', sans-serif !important;
            ...
            /*        mebership wrapper end*/


            /***********mebership wrapper show/hide************/
/*            .rs_membership_compatible_wrapper p{
                display:none;
            }
            .rs_membership_compatible_wrapper table{
            ...
            .rs_membership_compatible_wrapper div{
                display:none;
            }*/
            /***********mebership wrapper show/hide end ************/
...
/*            .rs_section_wrapper p{
    ...
    <?php } else { ?>
        <style>
            ...
            .rs_membership_compatible_wrapper h2{
                background: url(<?php echo REWARDSYSTEM_PLUGIN_DIR_URL . "admin/images/arrow-216-12.png" ?>) right 15px center no-repeat, linear-gradient(to bottom, rgba(240,240,240,1) 0%,rgba(255,255,255,1) 50%,rgba(240,240,240,1) 100%) !important;
                border:0px !important;
                font-size:16px !important;
                color:#333 !important;
                font-family: 'Roboto', sans-serif !important;
